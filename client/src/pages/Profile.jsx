        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red-700">
              Error image upload (less than 2 mb)
            </span>
...
//         </p>
//         <input  onChange={(e) => handlechange(e)}  type='text' placeholder='username'  defaultValue={currentUser.username} id='username' className='border rounded-lg p-3 '/>
//         <input onChange={(e) => handlechange(e)}   type='text' placeholder='email' defaultValue={currentUser.email} id='email' className='border rounded-lg p-3 ' />
//         <input onChange={(e) => handlechange(e)}   type='text' placeholder='password' id='password' className='border rounded-lg p-3 ' />
