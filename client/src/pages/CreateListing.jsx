  ...
  const handleImageSubmit = (e) => {
    if (file.length > 0 && ((file.length + formData.imageUrls.length) < 7)) {
      ...
      Promise.all(promises)
        ...
        .catch((err) => {
          setImageUploadError("iamge upload failed (2mb max)");
          setUploading(false);
        });
    } else {
...
//           <div className="flex flex-wrap gap-6 ">
//             <div className="flex gap-2">
//               <input type="checkbox" className="w-5" onChange={handleChange} id="sale" />
//               <span>Sell</span>
//             </div>
//             <div className="flex gap-2">
//               <input type="checkbox" className="w-5" onChange={handleChange} id="rent" />
//               <span>Rent</span>
//             </div>
//             <div className="flex gap-2">
//               <input type="checkbox" className="w-5" onChange={handleChange} id="parking" />
//               <span>Parking Spot</span>
//             </div>
//             <div className="flex gap-2">
//               <input type="checkbox" className="w-5" onChange={handleChange} id="furnised" />
//               <span>Furnised</span>
//             </div>
//             <div className="flex gap-2">
//               <input type="checkbox" className="w-5" onChange={handleChange} id="offer" />
//               <span>Offer</span>
//             </div>
//           </div>
...
//             <button type="button" disabled={uploading}  onClick={handleImageSubmit} className="p-3 text-green-700 border border-green-700  uppercase rounded hover:shadow-lg disabled:opacity-80">
//               {uploading ? 'Uploading' : "Upload"}
//             </button>
//             </div>
//             <p className='text-red-700 text-sm'>
